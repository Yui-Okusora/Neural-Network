...
Matrix& Matrix::add_nocopy(const Matrix& b)
{
    ...
    YuiOkusora::Math::Mat::addMatrix(this, const_cast<Matrix&>(b));
    return *this;
}
...
Matrix& Matrix::subtr_nocopy(const Matrix& b)
{
    ...
    YuiOkusora::Math::Mat::subtractMatrix(this, const_cast<Matrix&>(b));
    return *this;
}
...
Matrix& Matrix::multiply_nocopy(const Matrix& b)
{
    ...
    YuiOkusora::Math::Mat::multiplyMat2Matrix(this, const_cast<Matrix&>(b));
    return *this;
}
...
Matrix& Matrix::applyActivationDerivative_nocopy(ActivationType activation, const Matrix* scalar, float reluParam)
{
    ...
    YuiOkusora::Math::Mat::applyActivationDerivativeMatrix(this, activation, reluParam, const_cast<Matrix*>(scalar));
    return *this;
}
